...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('all.category') }}"
                    style="text-decoration: none;" class="text-gray-700">Danh sách thể loại</a>/</span>Sửa thể loại</h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="editCategory" action="{{ route('update.category') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Tên thể loại" value="{{ $loai->name }}"/>
                            </div>
                        </div>

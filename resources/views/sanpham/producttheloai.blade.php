    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
                    @php
                        ...
                        foreach ($sanphamsort as $sanpham){
                            foreach ($product as $sanphamid)
                            {
                                if ($sanphamid->sanpham_id == $sanpham->id)
                                {
                                    $tamsl = $tamsl + 1 ;
                                }
                            }
                    ...
                    <form class="ms-auto" action="{{ route('sanphamtheloai', $loaiSanpham->id) }}" method="GET"
                        id="form">
                ...
                <x-sanpham.productlisttheloai :sanphams="$sanphamsort" :product="$product" :image="$image" />
            </div>
        </div>
    </div>
</body>

<div class="card-body">
    <div class="table-responsive">
        <table id="ontheway" class="table table-hover" style="width:100%">
            <thead>
                <tr>
                    ...
                    @if ($order->order_status == 'On the way')
                        ...
                        <div class="modal fade" id="deleteModal{{ $order->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="deleteModal{{ $order->id }}Label">Hoàn thành
                                        </h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        Hoàn thành đơn hàng {{ $order->order_id_ref }} này ?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
                                        <form action="{{ route('update.orderonway') }}" method="post">
                                            @csrf
